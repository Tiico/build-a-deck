...
const setup: SetupDef = {
  ...
  zones: [
    ...
    { id: 'hand:C', kind: 'hand', name: 'Hand', visibility: 'owner', owner: 'C', returnTo: 'draw', geometry: rect(520, -200, 100, 400) },
  ],
...
export class Table {
  ...
  observerView(): Snapshot {
    return project(this.state, registry, null, undefined, this.deps.history, true)
  }
  activity(): Activity[] {
