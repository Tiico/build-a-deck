export const enAccount = {
  ...
  'home.new': '＋ New game',
  'home.empty': 'No game yet.',
  'home.help.topic': 'games',
  ...
  'wizard.help.spelet': 'the game',
  'wizard.help.falten': 'the fields',
  'wizard.help.korten': 'the cards',
  ...
  'wizard.name.says': 'The game needs a name first.',
  'wizard.players': 'Players',
  'wizard.blank.title': 'Without the guided start',
  'wizard.blank.body': 'Rather build everything yourself?',
  'wizard.blank.help': 'The game is made with the name and the seats above, with no cards, fields or template.',
  'wizard.blank.create': 'Create an empty game in the editor',

  'wizard.fields': 'Fields',
  'wizard.fields.body': 'The fields on every card.',
  'wizard.fields.help': 'Every field becomes a control on every example card straight away.',
