...
export const svPlay = {
  ...
  // Fördjupningen bakom frågetecknet (L32, #305). Raden vid koden är fyra ord; vad telefonen
  // blir när den ansluter står i lådan.
  ...
  // Fördjupningen bakom frågetecknet (L32, #305). Samma låda som i editorn, på en smalare skärm:
  // den täcker filtens övre del och ingenting man spelar med, och stängs med ett tryck utanför —
  // vilket på en telefon är nästan hela skärmen. Det som säger vad en handling får för följd
  // flyttar aldrig hit; raden över handen står kvar där den står.
  ...
  // Fördjupningen bakom frågetecknet (L32, #305). Att hon syns för alla står kvar på ytan i
  // `observer.banner`: synlighetsupplysningar flyttar aldrig in i lådan.
