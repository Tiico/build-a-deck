export const enEditor = {
  ...
  'tables.lead': 'Every table belongs to this game; a new one starts from the saved version, rev {n}. A table survives everyone disconnecting; it ends when it is ended, or after a day.',
