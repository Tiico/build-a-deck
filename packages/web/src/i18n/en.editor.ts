export const enEditor = {
  ...
  'editor.noProject': 'No project given.',
  'editor.loggingIn': 'Signing in…',
  'editor.loading': 'Loading the project…',
  ...
  'table.sort.none': 'Unsorted: the cards’ order in the project.',
  ...
  'tables.lead': 'Every table is a session from this game. A table survives everyone disconnecting; it ends when it is ended, or after a day.',
