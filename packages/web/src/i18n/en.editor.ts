export const enEditor = {
  ...
  'media.crop.keys': 'The arrows move the window; Shift takes a longer step. A focused corner resizes with the same keys.',
  'media.crop.corner.nw': 'Top left corner',
  'media.crop.corner.ne': 'Top right corner',
  'media.crop.corner.sw': 'Bottom left corner',
  'media.crop.corner.se': 'Bottom right corner',
  'media.crop.status.whole': 'The whole picture',
  'media.crop.status.saving': 'Changed — saving …',
  'media.crop.status.saved': 'Cropped · showing {p}%',
  'media.crop.mark': '▣ Cropped',
  'media.crop.mark.saving': '⟳ Saving …',
  'media.crop.done': 'Done',
  ...
  'wall.measure.help': 'The measure itself stands in the template’s image element, for {fields}. What stands here is the deck’s answer to it: the files that cannot answer, and each card’s own exception. The files are never touched.',
  'wall.measure.help.topic': 'the measure',
  ...
  'wall.checks.help': 'A fault is usually the template’s, not the card’s: it shows on every card that inherits the element.',
  'wall.checks.help.topic': 'the remarks',
  ...
  'table.symbol.box': 'Insert a symbol',
  'table.meaning.none': 'No meaning',
  'table.meanings.none': 'The game has no meanings; the symbol is drawn in ink.',
  'table.writes': 'Writes',
  ...
  'table.column.rename': 'Rename the column {field}',
  'table.column.name': 'Name of the column {field}',
  ...
  'canvas.help.move': 'The element itself is moved from the canvas: Enter goes into move mode, the arrows nudge.',
  ...
  'canvas.props.sec.layout': 'Layout',
  'canvas.props.sec.content': 'Content',
  'canvas.props.sec.text': 'Text',
  'canvas.props.sec.picture': 'Picture',
  'canvas.props.sec.fill': 'Fill',
  'canvas.props.sec.line': 'Line',
  'canvas.props.sec.effects': 'Effects',
  'canvas.props.grip': '{name}, drag to change',
  'canvas.props.x': 'X (mm)',
  'canvas.props.y': 'Y (mm)',
  ...
  'canvas.place.center': 'centred',
  'canvas.place.right': 'right',
  'canvas.place.top': 'top',
  'canvas.place.middle': 'middle',
  'canvas.place.bottom': 'bottom',
  'canvas.props.tune': 'Fine tuning',
  'canvas.props.lineHeight': 'Line spacing',
  'canvas.lineHeight.tight': 'tight (1.0)',
  'canvas.lineHeight.snug': '1.15',
  'canvas.lineHeight.normal': 'normal (1.25)',
  'canvas.lineHeight.airy': 'airy (1.5)',
  'canvas.props.letterSpacing': 'Letter spacing',
  'canvas.letterSpacing.tight': 'tight',
  'canvas.letterSpacing.normal': 'normal',
  'canvas.letterSpacing.wide': 'spaced',
  'canvas.letterSpacing.caps': 'small caps',
  'canvas.value.own': 'own: {value}',
  ...
  // The typeface catalog (#329, L27): a sheet under the card, where every hit sets the card's own words.
  'fonts.catalog.open': 'Search Google Fonts …',
  'fonts.catalog.title': 'Search Google Fonts',
  'fonts.catalog.search': 'Search {count} families',
  'fonts.catalog.close': 'Close',
  'fonts.catalog.category': 'Category',
  'fonts.catalog.category.alla': 'All',
  'fonts.catalog.category.serif': 'Serif',
  'fonts.catalog.category.sans': 'Sans',
  'fonts.catalog.category.display': 'Display',
  'fonts.catalog.category.handskrift': 'Handwriting',
  'fonts.catalog.category.mono': 'Mono',
  'fonts.catalog.hits': 'Matches',
  'fonts.catalog.meta': '{family} · {licence}',
  ...
  'fonts.catalog.foot': 'The samples are the card’s own words. The file is copied into the game.',
  'fonts.catalog.count': '{shown} of {all}',
  'fonts.catalog.silent': 'The catalog did not answer. The family could not be brought home.',
  'fonts.catalog.badge': 'Catalog',
  ...
  'symbols.colours.help.topic': 'the meanings',
  ...
  'symbols.help': 'Freely licensed symbols, placeholder frames and colour blocks. The licence travels with the print.',
  'symbols.help.topic': 'the library',
  ...
  'rules.empty': 'The rules belong to the game.',
  ...
  'rules.hint': 'Click in the page to write.',
  'rules.help.topic': 'the rules',
  'rules.help.reach': 'The rules are versioned with the cards, and the players reach them from the phone, the TV and the observer.',
  'rules.help.names': 'A rule that names a zone or a card follows it when it is renamed.',
  ...
  'setup.noRoomPile': 'No free felt for a new pile. Move or remove a zone first.',
  'setup.hint': 'Drag a zone on the felt to move it.',
  'setup.help.topic': 'the zones',
  'setup.help.resize': 'Drag the corner to resize it.',
  'setup.help.keys': 'The arrow keys nudge the chosen zone; Delete removes it.',
  'setup.help.list': 'The list is every zone the table has.',
  ...
  'setup.counters.help': 'One or two counters lie side by side in front of a seat. A third stacks the seat’s chips into one pile, which the table opens by name.',
  ...
  'setup.seats.help': 'A seat that arrives gets a hand and whatever the seats already have. A seat that leaves takes its zones with it.',
  'setup.seats.help.topic': 'the seats',
  ...
  'tables.lead': 'Tables on this game. A new one starts from the saved version, rev {n}.',
  ...
  'history.lead': 'The one you bring back becomes the next version.',
  'history.help.topic': 'the history',
  'history.help': 'Every save is a version, and none of them is rewritten.',
