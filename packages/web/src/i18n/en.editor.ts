export const enEditor = {
  ...
  'rules.import.images.one': '{n} picture came in and lies among the game’s own assets',
  'rules.import.images.other': '{n} pictures came in and lie among the game’s own assets',
  'rules.import.silent.one': '{n} picture with no alt text came in as decorative and is hidden from screen readers; it stands marked in the book and is counted in the column',
  'rules.import.silent.other': '{n} pictures with no alt text came in as decorative and are hidden from screen readers; they stand marked in the book and are counted in the column',
  'rules.import.left.mark': 'Did not come in',
  'rules.import.left.type': '{file} did not come in — the format cannot be printed; pictures come in as PNG, JPEG, WebP, GIF or SVG. The book is made without it.',
  'rules.import.left.big': '{file} did not come in — {mb} MB, and the limit is {limit} MB per picture. The book is made without it.',
  'rules.import.left.missing': '{file} did not come in — the file was not among the ones you picked. The book is made without it.',
  'rules.import.left.broken': '{file} did not come in — the file could not be read. The book is made without it.',
  ...
  'rules.import.noFile': 'No rules file was among the ones you picked. Pick the Markdown file together with the pictures it names.',
  ...
  'rules.image.decorative': 'Decorative · hidden from screen readers',
  'rules.image.noAlt': 'The picture carried no alt text in the file.',
  'rules.image.writeAlt': 'Write alt text',
  'rules.image.alt': 'Alt text',
  'rules.image.changeAlt': 'Change',
  'rules.image.altField': 'Alt text for the picture',
  'rules.image.altAsk': 'What the picture shows, for whoever cannot see it',
  'rules.image.caption': 'Caption',
  'rules.image.done': 'Done',
  'rules.image.found': 'Found · the picture you looked for',
  'rules.image.size': 'The booklet: {w} × {h} mm',
  'rules.image.px': '{w} × {h} px',
  'rules.image.fit.column': 'Fills the column',
  'rules.image.fit.height': 'Too tall for the page — narrows to fit',
  'rules.image.fit.own': 'Own size — never enlarged',
  'rules.toc.silent.one': '{n} · picture with no alt text',
  'rules.toc.silent.other': '{n} · pictures with no alt text',
