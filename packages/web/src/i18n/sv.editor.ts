...
export const svEditor = {
  ...
  'rules.import.image.one': '{n} bild kommer inte med ännu: boken har ännu inget blockslag för en bild (#173)',
  'rules.import.image.other': '{n} bilder kommer inte med ännu: boken har ännu inget blockslag för bilder (#173)',
