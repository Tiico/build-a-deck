...
export const svEditor = {
  ...
  'table.symbol.box': 'Infoga symbol',
  ...
  // Panelens avdelningar (L25). De står alltid öppna och har inget läge att minnas.
  'canvas.props.sec.layout': 'Layout',
  'canvas.props.sec.content': 'Innehåll',
  'canvas.props.sec.text': 'Text',
  'canvas.props.sec.picture': 'Bild',
  'canvas.props.sec.fill': 'Fyllning',
  'canvas.props.sec.line': 'Linje',
  'canvas.props.sec.effects': 'Effekter',
  'canvas.props.grip': '{name}, dra för att ändra',
  'canvas.props.x': 'X (mm)',
  'canvas.props.y': 'Y (mm)',
  ...
  'canvas.place.at': '{x}, {y}',
  'canvas.place.left': 'vänster',
  'canvas.place.center': 'centrerat',
  'canvas.place.right': 'höger',
  'canvas.place.top': 'topp',
  'canvas.place.middle': 'mitten',
  'canvas.place.bottom': 'botten',
  // Luckan och de två avstånden bakom den (L41).
  'canvas.props.tune': 'Finjustering',
  'canvas.props.lineHeight': 'Radavstånd',
  'canvas.lineHeight.tight': 'tätt (1,0)',
  'canvas.lineHeight.snug': '1,15',
  'canvas.lineHeight.normal': 'normalt (1,25)',
  'canvas.lineHeight.airy': 'luftigt (1,5)',
  'canvas.props.letterSpacing': 'Teckenavstånd',
  'canvas.letterSpacing.tight': 'knip',
  'canvas.letterSpacing.normal': 'normalt',
  'canvas.letterSpacing.wide': 'spärrat',
  'canvas.letterSpacing.caps': 'versaler',
  'canvas.value.own': 'eget: {value}',
  ...
  // Typsnittskatalogen (#329, L27): ett ark under kortet, där varje träff sätter kortets egna ord.
  'fonts.catalog.open': 'Sök i Google Fonts …',
  'fonts.catalog.title': 'Sök i Google Fonts',
  'fonts.catalog.search': 'Sök bland {count} familjer',
  'fonts.catalog.close': 'Stäng',
  'fonts.catalog.category': 'Kategori',
  'fonts.catalog.category.alla': 'Alla',
  'fonts.catalog.category.serif': 'Serif',
  'fonts.catalog.category.sans': 'Sans',
  'fonts.catalog.category.display': 'Display',
  'fonts.catalog.category.handskrift': 'Handskrift',
  'fonts.catalog.category.mono': 'Mono',
  'fonts.catalog.hits': 'Träffar',
  ...
  'fonts.catalog.foot': 'Proven är kortets egna ord. Filen kopieras in i spelet.',
  ...
  'setup.addArea': '＋ Yta',
  'setup.addPile': '＋ Hög',
  // När filten inte har en ledig ruta att föda zonen i (#440, #443). Den säger vad som saknas och
  // vad som gör den ledig igen, eftersom en vägran utan väg vidare är en knapp som ser trasig ut.
  // Högen har egna ord och inte ytans: en ruta på 300 × 120 mm och en kortrygg på 63 × 88 mm
  // slutar få plats vid olika tillfällen, så «ingen ledig filt» är sant för den ena medan det är
  // falskt för den andra — och en mening som nämner fel zon är en mening formgivaren får leta i.
  'setup.noRoom': 'Ingen ledig filt för en ny yta. Flytta eller ta bort en zon först.',
  'setup.noRoomPile': 'Ingen ledig filt för en ny hög. Flytta eller ta bort en zon först.',
